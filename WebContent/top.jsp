	...
	<div class="container">
		...
		<div class="main">
			<c:if test="${not empty message}">
				<div class="messageFont" >${message}</div>
			</c:if>
			<c:choose>
				...
				<c:otherwise>
					...
					<form action="form" method="post">
						<textarea class="inTextArea" name="post" rows="6" cols="60" wrap="hard" placeholder="140文字以下で入力して下さい " onblur="coloeSet(this)" onfocus="coloReset(this)" onkeyup="ShowLength(value);DisableButton(value)"></textarea>
							<div class="underPosts">
								<div class="post-button">
									<input type="submit" value="Post"  id="button" class="button" />
									<input type="hidden" name="action" value="post" />
								</div>
								<div class="postLengthCount"><p id="inputlength">140</p></div>
							</div>
					</form>
					<hr />
					<div class="postList">
